...
class PostureStruct:
    ...
    This class contains attributes that define the dimensions and positions of different body parts
    of a fish.

    Attributes:
        seg_width (np.ndarray): An array representing the widths of different segments of the fish
        body.
        head_width (np.ndarray): An array representing the widths of different segments of the fish
        head.
        ...
        hy_pos (np.ndarray): An array representing the positive y-offsets of the fish's head
        segments.
        hy_neg (np.ndarray): An array representing the negative y-offsets of the fish's head
        segments.
        ...
        y_pos (np.ndarray): An array representing the positive y-offsets of the fish's body
        segments.
        y_neg (np.ndarray): An array representing the negative y-offsets of the fish's body
        segments.
    """
